      ...
      <View style={{ position: 'absolute', left: 14, right: 14, bottom: 13 }}>
        ...
        {big ? (
          <View style={{ flexDirection: 'row', gap: 12, marginTop: 6 }}>
            <Text style={{ color: '#fff', fontSize: 12.5, opacity: 0.9 }}>
              {d.processing}
            </Text>
            <Text style={{ color: '#fff', fontSize: 12.5, opacity: 0.5 }}>
              ·
            </Text>
            <Text style={{ color: '#fff', fontSize: 12.5, opacity: 0.9 }}>
              {d.applied.toLocaleString()} applied
            </Text>
          </View>
        ) : null}
      </View>
