  ...
  return (
    <Pressable
      ...
      style={{
        ...
        borderRadius: 20,
        borderWidth: 1,
        borderColor: dark ? 'transparent' : EX.color.line10,
        backgroundColor: dark ? EX.color.ink : '#fff',
        shadowColor: '#171326',
        shadowOpacity: dark ? 0.4 : 0.04,
        shadowRadius: dark ? 20 : 2,
        shadowOffset: { width: 0, height: dark ? 12 : 1 },
        elevation: dark ? 6 : 1,
      }}
    >
      <View
        style={{
          ...
          backgroundColor: dark ? 'rgba(255,255,255,0.12)' : EX.color.cream,
        }}
      >
        <IconCmp
          size={21}
          color={dark ? EX.color.bg : accent}
          strokeWidth={1.8}
        />
      </View>
      <View style={{ flex: 1, minWidth: 0 }}>
        <Text
          style={{
            fontSize: 15.5,
            fontWeight: '700',
            color: dark ? EX.color.bg : EX.color.ink,
          }}
          numberOfLines={1}
        >
          {title}
        ...
        <Text
          style={{
            fontSize: 12.5,
            marginTop: 2,
            color: dark ? 'rgba(255,251,245,0.72)' : 'rgba(23,19,38,0.6)',
          }}
          numberOfLines={1}
        >
          {sub}
      ...
      {badge ? (
        <View
          style={{
            backgroundColor: dark ? 'rgba(255,255,255,0.16)' : EX.color.cream,
            borderRadius: 999,
        ...
        <Ic.chevR
          size={20}
          color={dark ? EX.color.bg : EX.color.muted}
          strokeWidth={1.8}
        />
      )}
    </Pressable>
...
export default function DestinationDetail() {
  ...
  // Create-application: the self-service path creates a real application for a
  // live visa, then opens self-service with that application id (which unlocks
  // live document upload). Demo dests / failures fall back to the demo flow.
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <StatCell
              value={`$${d.price.toLocaleString()}`}
              label="Starting at"
              accent={EX.color.primary}
            />
            <View
              style={{ width: 1, height: 30, backgroundColor: EX.color.line08 }}
            />
          ...
          <View style={{ gap: 10 }}>
            <PathCard
              ...
              badge="Popular"
              onPress={() =>
                router.push(`/(explorer)/agent/${topAgents[0].id}`)
              }
            />
            <PathCard
              icon={Ic.docs}
              title="Self-service"
              sub="Step-by-step DIY application"
          ...
          <Pressable
            ...
            style={{
              ...
              marginTop: 18,
              borderWidth: 1,
              borderColor: EX.color.tealTint14,
              backgroundColor: EX.color.tealTint08,
            }}
          >
            <View
              style={{
            ...
            <View style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                Answer 5 quick questions · 2 min
              </Text>
            </View>
          ...
          >
            ...
            <View style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                Success rates &amp; common reasons for refusal
              </Text>
            </View>
              ...
              >
                ...
                >
                  ...
                  <View style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <Text
                      style={{ fontSize: 11.5, color: EX.color.muted }}
                      numberOfLines={1}
                    >
                      {a.spec}
                    </Text>
                ...
                >
                  ...
                  <View
                    style={{
                      backgroundColor: EX.color.tealTint10,
                      borderRadius: 999,
                      paddingHorizontal: 8,
                      paddingVertical: 3,
                    }}
