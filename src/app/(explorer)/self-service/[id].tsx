...
function liveDocChip(status: DocumentStatus): {
  ...
  switch (status) {
    case 'verified':
      return { kind: 'verified', label: 'Verified', fg: '#1E8E55', bg: '#D6F2E2' };
    case 'uploaded':
    case 'under_review':
      return { kind: 'review', label: 'In review', fg: '#2F62A0', bg: '#DCEBF7' };
    case 'rejected':
    case 'resubmission_required':
      return { kind: 'rejected', label: 'Rejected', fg: '#C0453C', bg: '#FBE3E1' };
    default:
