    ...
    >
      ...
      <View style={{ flex: 1, minWidth: 0 }}>
        ...
        >
          ...
          <Text
            style={{ fontSize: 11.5, fontWeight: '700', color: EX.color.muted }}
          >
  ...
  return (
    ...
    >
      ...
      >
        <View>
          <Text
            style={{ fontSize: 13, color: EX.color.muted, fontWeight: '600' }}
          >
            Good morning
          </Text>
          <Text style={[displayText(27, 'semibold'), { marginTop: 2 }]}>
            {ME.name}
          </Text>
        </View>
            ...
            >
              ...
              <BlurView
                ...
                style={{
                  ...
                  borderWidth: 1,
                  borderColor: 'rgba(255,255,255,0.28)',
                  backgroundColor: 'rgba(20,16,12,0.24)',
                  alignItems: 'center',
                  justifyContent: 'center',
                }}
              >
      ...
      {actionApp.next.cta ? (
        ...
        >
          <Pressable
            onPress={() =>
              router.push(`/(explorer)/application/${actionApp.id}`)
            }
            style={{
              flexDirection: 'row',
              alignItems: 'center',
          ...
          >
            ...
            <View style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                Action needed · {dAction.country}
              </Text>
              <Text
                style={{ fontSize: 14.5, fontWeight: '700', color: '#fff' }}
                numberOfLines={1}
              >
                {actionApp.next.label}
              </Text>
            </View>
            <View
              style={{
      ...
      >
        <QuickAction
          icon={Ic.globe}
          label="Explore visas"
          tone={{ bg: EX.color.primaryTint10, fg: EX.color.primary }}
          onPress={() => router.push('/(explorer)/(tabs)/explore')}
        />
        <QuickAction
          icon={Ic.shield}
          label="Check eligibility"
          tone={{ bg: EX.color.tealTint14, fg: EX.color.success }}
          onPress={() =>
            router.push({
              pathname: '/(explorer)/eligibility',
              params: { dest: DESTS[0].id },
            })
          }
        />
        <QuickAction
          icon={Ic.users}
          label="Find an agent"
          tone={{ bg: EX.color.purpleTint, fg: EX.color.purple }}
          onPress={() => router.push('/(explorer)/(tabs)/agents')}
        />
      </View>
      ...
      <View style={{ paddingHorizontal: 22 }}>
        ...
        >
          ...
          <Pressable
            onPress={() => router.push('/(explorer)/(tabs)/tracker')}
            hitSlop={8}
          >
            <Text
              style={{
            ...
            <React.Fragment key={a.id}>
              {i > 0 ? (
                <View
                  style={{
                    height: 1,
                    backgroundColor: EX.color.line06,
                    marginHorizontal: 12,
                  }}
                />
              ) : null}
      ...
      <ScrollView
        ...
        contentContainerStyle={{
          gap: 13,
          paddingHorizontal: 22,
          paddingBottom: EX.space.tabClear,
        }}
      >
        {rec.map((d) => (
          <RecoCard
